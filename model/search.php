            ...
            <div class="container">
                <div class="row">
                    <div class="cartegory-left">
                        <ul>
                            <li class="cartegory-left-li"><a href="../giohang.php">Áo</a>
                            <ul>
                                <li><a href="../giohang.php">Áo mới</a></li>
                                <li><a href="../giohang.php">Áo 1</a></li>
                            </ul>
                            </li>
                            <li class="cartegory-left-li"><a href="../giohang.php">Quần</a>
                                <ul>
                                    <li><a href="../giohang.php">Quần mới</a></li>
                                    <li><a href="../giohang.php">Quần 1</a></li>
                                </ul>
                            </li>
                            <li class="cartegory-left-li"><a href="../giohang.php">Bộ</a>
                                <ul>
                                    <li><a href="../giohang.php">Bộ mới</a></li>
                                    <li><a href="../giohang.php">Bộ 1</a></li>
                                </ul>
                            </li>
                            <li class="cartegory-left-li"><a href="../giohang.php">CLB</a>
                                <ul>
                                    <li><a href="../giohang.php">CLB mới</a></li>
                                    <li><a href="../giohang.php">CLB 1</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
